// MCP Bridge - routes commands to handler subsystems
    ...
    AsyncTask(ENamedThreads::GameThread, [this, CommandType, Params, Promise = MoveTemp(Promise)]() mutable
    {
        ...
        try
        {
            ...
            // Editor Commands (including actor manipulation)
                     ...
                     CommandType == TEXT("assign_skeleton"))
            {
            ...
            // Blueprint Commands
                     ...
                     CommandType == TEXT("delete_datatable_row") ||
                     CommandType == TEXT("add_datatable_row") ||
                     CommandType == TEXT("rename_datatable_row") ||
                     ...
                     CommandType == TEXT("fix_retarget_root_motion") ||
                     ...
                     CommandType == TEXT("get_all_levels") ||
                     // Lighting & Cameras
                     CommandType == TEXT("spawn_light") ||
                     CommandType == TEXT("set_light_properties") ||
                     CommandType == TEXT("spawn_camera") ||
                     CommandType == TEXT("set_camera_properties") ||
                     // Collision & Physics
                     CommandType == TEXT("set_actor_collision_preset") ||
                     CommandType == TEXT("set_collision_enabled") ||
                     // Import/Export
